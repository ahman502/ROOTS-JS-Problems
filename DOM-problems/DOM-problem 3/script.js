function outputItem() {                                                                                         // function declaration
    ...
    for(i = 0; i < document.getElementById("drop-down").length; i++) {                                          // for loop to go through th length of the drop-down menu
        optionsArray.push(document.getElementById("drop-down").options[i].text);                                // pushing teh text of each option at each index to the array
    }
